...
export const findById = async function (id_persona) {
  console.log("------------schema------------");
  const results = await Persona.findById({ _id: id_persona });
  console.log(results);
  return results;
};
...
export const update = async function (id_persona, objUsuario) {
  console.log("------------schema------------");
  const results = await Persona.findByIdAndUpdate(id_persona, {
...
export const findEliminarXId = async function (id_persona) {
  console.log("------------schema------------");
  const results = await Persona.deleteOne({ _id: id_persona });
  console.log(results);
  return results;
};
